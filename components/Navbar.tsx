...
import { FaArrowLeft, FaBars, FaRightToBracket } from "react-icons/fa6";
  ...
  return (
    <div className="w-full flex justify-between items-center sticky top-0 p-2 pr-4 bg-white z-[10000]">
      ...
      <div className="flex items-center sm:gap-6 gap-2 cursor-pointer">
        ...
        <button className="cursor-pointer active:scale-95 transition-transform duration-100 ease-in-out flex items-center gap-2">
